...
public class WaterFlowDemo : MonoBehaviour
{
		...
		foreach(Transform child in transform)
		{
			...
			switch(m_WaterList[i].gameObject.GetComponent<Renderer>().material.shader.name)
			{
				...
				case "Water Flow/Water Diffuse":
					...
					m_WaterDiffuseOriginal_Diffuse 		= m_WaterList[i].gameObject.GetComponent<Renderer>().material.GetColor("_Color");
					m_WaterDiffuseOriginal_Multiply 	= m_WaterList[i].gameObject.GetComponent<Renderer>().material.GetFloat("_Multiply");
					m_WaterDiffuseOriginal_UMoveSpeed 	= m_WaterList[i].gameObject.GetComponent<Renderer>().material.GetFloat("_MoveSpeedU");
					m_WaterDiffuseOriginal_VMoveSpeed 	= m_WaterList[i].gameObject.GetComponent<Renderer>().material.GetFloat("_MoveSpeedV");
				...
				case "Water Flow/Water Simple":
					...
					m_WaterSimpleOriginal_Color		= m_WaterList[i].gameObject.GetComponent<Renderer>().material.GetColor("_Color");;
					m_WaterSimpleOriginal_UMoveSpeed 	= m_WaterList[i].gameObject.GetComponent<Renderer>().material.GetFloat("_MoveSpeedU");
					m_WaterSimpleOriginal_VMoveSpeed 	= m_WaterList[i].gameObject.GetComponent<Renderer>().material.GetFloat("_MoveSpeedV");
					
					m_WaterSimpleOld_Color			= m_WaterSimple_Color			= m_WaterSimpleOriginal_Color;
	...
	void OnGUI ()
	{
		...
		// Show version number
		GUI.Window(1, new Rect((Screen.width-260), 5, 250, 80), AppNameWindow, "Water Flow 1.0.5");
	...
	void WaterDiffuseGUIWindow(int id)
	{
		...
		GUI.Label( new Rect(10, 25, 65, 22), "Red" );
		GUI.Label( new Rect(10, 45, 65, 22), "Green" );
		GUI.Label( new Rect(10, 65, 65, 22), "Blue" );
		GUI.Label( new Rect(10, 85, 65, 22), "Alpha" );
        ...
        if(m_WaterDiffuseOld_Diffuse != m_WaterDiffuse_Diffuse)
		{
			...
			m_WaterList[m_CurrentWaterIndex].gameObject.GetComponent<Renderer>().material.SetColor("_Color", m_WaterDiffuse_Diffuse);
		}
		...
		if(m_WaterDiffuseOld_Multiply != m_WaterDiffuse_Multiply)
		{
			...
			m_WaterList[m_CurrentWaterIndex].gameObject.GetComponent<Renderer>().material.SetFloat("_Multiply", m_WaterDiffuse_Multiply);
		...
		if(m_WaterDiffuseOld_UMoveSpeed != m_WaterDiffuse_UMoveSpeed)
		{
			...
			m_WaterList[m_CurrentWaterIndex].gameObject.GetComponent<Renderer>().material.SetFloat("_MoveSpeedU", m_WaterDiffuse_UMoveSpeed);
        }
		...
		if(m_WaterDiffuseOld_VMoveSpeed != m_WaterDiffuse_VMoveSpeed)
		{
			...
			m_WaterList[m_CurrentWaterIndex].gameObject.GetComponent<Renderer>().material.SetFloat("_MoveSpeedV", m_WaterDiffuse_VMoveSpeed);
        }
		...
		if(GUI.Button( new Rect(125, 200, 150, 30), "Reset"))
		{
			...
			m_WaterList[m_CurrentWaterIndex].gameObject.GetComponent<Renderer>().material.SetColor("_Color", m_WaterDiffuseOriginal_Diffuse);
			m_WaterList[m_CurrentWaterIndex].gameObject.GetComponent<Renderer>().material.SetFloat("_Multiply", m_WaterDiffuseOriginal_Multiply);
			m_WaterList[m_CurrentWaterIndex].gameObject.GetComponent<Renderer>().material.SetFloat("_MoveSpeedU", m_WaterDiffuseOriginal_UMoveSpeed);
			m_WaterList[m_CurrentWaterIndex].gameObject.GetComponent<Renderer>().material.SetFloat("_MoveSpeedV", m_WaterDiffuseOriginal_VMoveSpeed);
	...
	{
		// Simple Light sliders
		GUI.Label( new Rect(10, 25, 65, 22), "Red" );
		GUI.Label( new Rect(10, 45, 65, 22), "Green" );
		GUI.Label( new Rect(10, 65, 65, 22), "Blue" );
		GUI.Label( new Rect(10, 85, 65, 22), "Alpha" );
		m_WaterSimple_Color = new Color (GUI.HorizontalSlider( new Rect(125, 30, 150, 15), m_WaterSimple_Color.r, 0f, 1f),
		                                   GUI.HorizontalSlider( new Rect(125, 50, 150, 15), m_WaterSimple_Color.g, 0f, 1f),
		                                   GUI.HorizontalSlider( new Rect(125, 70, 150, 15), m_WaterSimple_Color.b, 0f, 1f),
		                                   GUI.HorizontalSlider( new Rect(125, 90, 150, 15), m_WaterSimple_Color.a, 0f, 1f));
		if(m_WaterSimpleOld_Color != m_WaterSimple_Color)
		{
			PauseOrbitCamera(); // pause orbit camera
			m_WaterSimpleOld_Color = m_WaterSimple_Color;
			//Debug.Log("m_WaterSimple_Color="+m_WaterSimple_Color);
			m_WaterList[m_CurrentWaterIndex].gameObject.GetComponent<Renderer>().material.SetColor("_Color", m_WaterSimple_Color);
        }        
		...
		if(m_WaterSimpleOld_UMoveSpeed != m_WaterSimple_UMoveSpeed)
		{
			...
			m_WaterList[m_CurrentWaterIndex].gameObject.GetComponent<Renderer>().material.SetFloat("_MoveSpeedU", m_WaterSimple_UMoveSpeed);
		}
		...
		if(m_WaterSimpleOld_VMoveSpeed != m_WaterSimple_VMoveSpeed)
		{
			...
			m_WaterList[m_CurrentWaterIndex].gameObject.GetComponent<Renderer>().material.SetFloat("_MoveSpeedV", m_WaterSimple_VMoveSpeed);
		}
		...
		if(GUI.Button( new Rect(125, 175, 150, 30), "Reset"))
		{
			// Load Original shader values
			m_WaterList[m_CurrentWaterIndex].gameObject.GetComponent<Renderer>().material.SetColor("_Color", m_WaterSimple_Color);
			m_WaterList[m_CurrentWaterIndex].gameObject.GetComponent<Renderer>().material.SetFloat("_MoveSpeedU", m_WaterSimpleOriginal_UMoveSpeed);
			m_WaterList[m_CurrentWaterIndex].gameObject.GetComponent<Renderer>().material.SetFloat("_MoveSpeedV", m_WaterSimpleOriginal_VMoveSpeed);

			// Update GUI objects
			m_WaterSimple_Color = new Color (GUI.HorizontalSlider( new Rect(125, 30, 150, 15), m_WaterSimpleOriginal_Color.r, 0f, 1f),
			                                   GUI.HorizontalSlider( new Rect(125, 50, 150, 15), m_WaterSimpleOriginal_Color.g, 0f, 1f),
			                                   GUI.HorizontalSlider( new Rect(125, 70, 150, 15), m_WaterSimpleOriginal_Color.b, 0f, 1f),
			                                   GUI.HorizontalSlider( new Rect(125, 90, 150, 15), m_WaterSimpleOriginal_Color.a, 0f, 1f));
	...
	void UpdateCurrentShaderType()
	{
		...
		switch(m_WaterList[m_CurrentWaterIndex].gameObject.GetComponent<Renderer>().material.shader.name)
		{
			...
			case "Water Flow/Water Diffuse":
				...
				m_WaterDiffuse_Diffuse 				= m_WaterList[m_CurrentWaterIndex].gameObject.GetComponent<Renderer>().material.GetColor("_Color");
				m_WaterDiffuse_Multiply 			= m_WaterList[m_CurrentWaterIndex].gameObject.GetComponent<Renderer>().material.GetFloat("_Multiply");
				m_WaterDiffuse_UMoveSpeed 			= m_WaterList[m_CurrentWaterIndex].gameObject.GetComponent<Renderer>().material.GetFloat("_MoveSpeedU");
				m_WaterDiffuse_VMoveSpeed 			= m_WaterList[m_CurrentWaterIndex].gameObject.GetComponent<Renderer>().material.GetFloat("_MoveSpeedV");
			...
			case "Water Flow/Water Simple":
				...
				m_WaterSimple_Color					= m_WaterList[m_CurrentWaterIndex].gameObject.GetComponent<Renderer>().material.GetColor("_Color");
				m_WaterSimple_UMoveSpeed 			= m_WaterList[m_CurrentWaterIndex].gameObject.GetComponent<Renderer>().material.GetFloat("_MoveSpeedU");
				m_WaterSimple_VMoveSpeed 			= m_WaterList[m_CurrentWaterIndex].gameObject.GetComponent<Renderer>().material.GetFloat("_MoveSpeedV");
