Obfuscator v3.10.2 Copyright (c) 2015-2022 Beebyte Limited. All Rights Reserved
...
A. In the example given in the question, somewhere on your system would be a System.Collections.dll file of version 4.0.0.0. To fix the error, locate this file then add its location to the "Referenced Assemblies" array within Options.
...
A. Please email support@beebyte.co.uk giving as much information about the problem as possible along with the following:
